function siguientePaso() {
    ...
    if (nombre) {
        ...
        document.getElementById('mensaje').innerText = `Hola Sofia, mira te hago esta carta, si se puede llamar de una manera, ya que la verdad te quería desear un Feliz cumpleaños.
